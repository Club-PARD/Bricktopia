...
class TodayWeatherCard extends StatelessWidget {
  ...
  TodayWeatherCard({super.key, required this.groupedWeatherDataList});
            ...
            children: [
              ...weatherDataList.map((weatherData) {
                ...
                String formattedDate =
                    weatherData.time.toString().split(' ')[0];
                String formattedTime =
                    weatherData.time.toString().split(' ')[1];
                //print(formattedDate);
                //print(formattedTime);
                ...
                dd =
                    "${dd!}날짜 및 시간: $finalDate $finalTime, 날씨: $mainWeather, 최고 온도: ${weatherData.maxTemperature.toStringAsFixed(1)}°C, 최저 온도: ${weatherData.minTemperature.toStringAsFixed(1)}°C, 강수 확률: ${(weatherData.pop * 100).toInt()}%, 습도: ${weatherData.humidity.toInt()}% \n";
                print(dd);
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('\n$finalDate $finalTime\n'),
                          Text(
                              '최고 온도: ${weatherData.maxTemperature.toStringAsFixed(1)}°C'),
                          Text(
                              '최저 온도: ${weatherData.minTemperature.toStringAsFixed(1)}°C'),
