...
class AddSummaryBoxWidget extends StatefulWidget {
  final double longitude;
  final double latitude;

  const AddSummaryBoxWidget({
    super.key,
  ...
  @override
  State<AddSummaryBoxWidget> createState() => _AddSummaryBoxWidgetState();
}

class _AddSummaryBoxWidgetState extends State<AddSummaryBoxWidget> {
  bool isTts = false;
