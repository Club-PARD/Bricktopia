...
class _HomeSummaryBoxWidgetState extends State<HomeSummaryBoxWidget> {
  ...
  Future<String> makeASummary() async {
    ...
    final aiWeather = "$weatherSummary + 어떤 하루가 예상 되는지 예시로 25글자 이내";
                  ...
                  Row(
                    ...
                    children: [
                      IconButton(
                        ...
                        icon: Image.asset(
                          'assets/toggle/Button_briefing.png',
                          height: 40,width: 40,
                      ...
                      IconButton(
                        ...
                        icon: isContainerVisible
                            ? Image.asset("assets/toggle/toggle_up.png",height: 20,width: 20,)
                            : Image.asset("assets/toggle/toggle_down.png",height: 20,width: 20,),
                      ),
                    ],
                  ),
                ],
