...
class FiveDayWeatherWidget extends StatefulWidget {
  final List<Map<String, dynamic>> weatherList;

  const FiveDayWeatherWidget({super.key, required this.weatherList});

  @override
  State<FiveDayWeatherWidget> createState() => _FiveDayWeatherWidgetState();
}

class _FiveDayWeatherWidgetState extends State<FiveDayWeatherWidget> {
  @override
