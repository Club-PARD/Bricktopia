...
class HourlyBookWeathertWidget extends StatefulWidget {
  final List<Map<String, dynamic>> weatherList;

  const HourlyBookWeathertWidget({super.key, required this.weatherList});

  @override
  State<HourlyBookWeathertWidget> createState() =>
      _HourlyBookWeathertWidgetState();
}

class _HourlyBookWeathertWidgetState extends State<HourlyBookWeathertWidget> {
  @override
